...
exact product version and artifact set. For example, the `0.43.0` train
publishes Manual content under `/manual/0.43/` while the train metadata
identifies the exact `0.43.0` artifacts.
